      ...
      <div>
        <SidebarLayout activeTab='code'>
          ...
          <div className='my-3'>
            ...
            <p className='my-1 text-sm text-gray-500'>PROTIP: Use the <a target="_blank" rel="noopener noreferrer" className="underline" href='https://chrome.google.com/webstore/detail/stylebot/oiaejidbmkiecgbjeifoejpgmdaleoha'>`Stylebot`</a> extension to style your website without code. View demo at <a className="underline" target="_blank" rel="noopener noreferrer" {process.env.NEXT_PUBLIC_LOOM_VIDEO_URL}>here</a>.</p>
          </div>
          <div className='mt-8'>
